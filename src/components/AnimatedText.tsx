...
const AnimatedText = () => {
  ...
  return (
    <div className="relative max-w-[1400px] mx-auto">
      ...
      <div className="container-animate text-center flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
        ...
        {(!isMobile || window.innerWidth >= 768) && (
          <img 
            ...
            alt="Profile"
            className="w-72 md:w-[21rem] lg:w-[28rem] h-auto object-contain -mb-20 md:translate-x-6 z-10"
          />
        )}
        {isMobile && (
          <div className="flex flex-col items-center w-full">
            <img 
              src="/lovable-uploads/26928ad4-83d9-40e0-903a-a6bc8765c7c6.png"
              alt="Profile"
              className="w-56 h-auto object-contain -mb-16 z-10"
            />
          </div>
        )}
      </div>
